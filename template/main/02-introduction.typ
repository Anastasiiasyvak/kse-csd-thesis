...
The broader problem MovieCrush addresses is one that a survey of 262 respondents confirmed: 49.8% of people track films in phone notes, and 83.6% discover content through social media rather than dedicated platforms. Existing solutions each cover only part of the user journey - Letterboxd handles films but ignores series, TV Time covers series but has weak recommendations and no social transparency, and IMDb is a reference database rather than a personal tracking tool. The core question "what should I watch tonight?" remains poorly answered by all of them.

== Objectives

The goal of this capstone project is to design, build, and evaluate a complete cross-platform mobile application that unifies film and TV tracking, personalized recommendations, social discovery, and personal analytics in a single product.

The specific objectives are:

- Build a fully functional mobile app for Android (with iOS compatibility) using React Native and Expo
...
Before writing a single line of code, three complementary research methods were applied: a quantitative survey of 262 respondents, five qualitative in-depth interviews, and a structured competitor gap analysis covering Letterboxd, IMDb, TV Time, and Moviebase. This ensured that product decisions were grounded in real user needs rather than assumptions.
...
- *Analysis* - user research findings, competitor gap analysis, business model, and domain-specific technical challenges
